...
export default function AnimatedBackground() {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden" aria-hidden="true">
      <div
        className={`absolute inset-0 bg-[linear-gradient(rgba(14,165,233,0.09)_1px,transparent_1px),linear-gradient(90deg,rgba(16,185,129,0.08)_1px,transparent_1px)] bg-[size:64px_64px] opacity-45 dark:opacity-35 ${
          prefersReducedMotion ? "" : "animate-slow-pan"
        }`}
      />
      ...
      <div
        className={`absolute left-1/2 top-0 h-full w-px bg-gradient-to-b from-transparent via-cyan-400/40 to-transparent ${
          prefersReducedMotion ? "" : "animate-pulse-line"
        }`}
      />
